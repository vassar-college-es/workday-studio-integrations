...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2.0" xmlns:mx="meteorix">
    ...
    <xsl:template match="/">
        <env:Envelope xmlns:env="http://schemas.xmlsoap.org/soap/envelope/"
            ...
            <env:Body>
                <wd:Change_Benefits_Request xmlns:wd="urn:com.workday/bsvc" wd:Add_Only="true"
                    wd:version="v26.2">
