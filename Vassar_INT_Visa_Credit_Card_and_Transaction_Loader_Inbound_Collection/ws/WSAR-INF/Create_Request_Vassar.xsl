...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="record.four.corpaccount"/>
...
<!--                                 <xsl:value-of select="File/Record_05/trans_num"/>  -->
                            ...
                            <wd:Source_Currency_Reference><wd:ID wd:type="Currency_Numeric_Code"><xsl:value-of select="format-number(File/Record_05/src_cur_cd, '000')"/></wd:ID></wd:Source_Currency_Reference>
                            ...
                            <wd:Corporate_Account_Reference>
                                ...
                                <wd:ID wd:type="Corporate_Credit_Card_Account_ID"><xsl:value-of select="$record.four.corpaccount"/></wd:ID>
                            </wd:Corporate_Account_Reference>
