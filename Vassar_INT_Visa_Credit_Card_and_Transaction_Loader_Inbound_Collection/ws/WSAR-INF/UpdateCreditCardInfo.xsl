   ...
   <xsl:param name="CC.status.date"/>
    ...
    <xsl:template match="/">
        <env:Envelope xmlns:env="http://schemas.xmlsoap.org/soap/envelope/"
            ...
            <env:Body>
                <wd:Put_Expense_Credit_Card_Request xmlns:wd="urn:com.workday/bsvc" wd:Add_Only="0"
                    wd:version="v26.1">
              
                        <wd:Expense_Credit_Card_Reference>
                            <wd:ID wd:type="Expense_Credit_Card_ID">
                                <xsl:value-of select="$ExpenseCreditCardID"/>
                            </wd:ID>
                        </wd:Expense_Credit_Card_Reference>
